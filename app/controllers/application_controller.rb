class ApplicationController < ActionController::Base
  ...
  protected
      ...
      def configure_permitted_parameters
          devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:first_name, :last_name, :username, :email, :about_me, :password, :avatar, :avatar_cache, :time_zone) }
          devise_parameter_sanitizer.for(:account_update) { |u| u.permit(:first_name, :last_name, :username, :email, :about_me, :password, :current_password, :avatar, :avatar_cache, :time_zone) }
      end
